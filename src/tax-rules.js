...
/**
 * 끝수(절사) 규정 — 국고금관리법 제47조 (S-04에서 원문 확인, 2026-08-19)
 *   https://www.law.go.kr/법령/국고금관리법/제47조
 *
 *   제1항 국고금의 수입 또는 지출에서 10원 미만의 끝수가 있을 때에는 그 끝수는
 *        계산하지 아니하고, 전액이 10원 미만일 때에도 그 전액을 계산하지 아니한다.
 *   제2항 국세의 과세표준액을 산정할 때 1원 미만의 끝수가 있으면 이를 계산하지 아니한다.
 *
 * 즉 계산 과정(과세표준·산출세액·공제)은 원 단위,
 * 실제로 납부하는 금액만 10원 미만을 버린다.
 */

/** 과세표준 절사 단위 — 제47조 제2항 */
export const TAX_BASE_ROUNDING_UNIT = 1;

/** 납부할 세액 절사 단위 — 제47조 제1항 */
export const PAYMENT_ROUNDING_UNIT = 10;
